...
model_path = 'CNNI_AFM_res152_fine2-3label-train_val_total'
...
PATH = os.path.join(base_path, 'Models/CNNI_Res152_fine2label/Fold2.pth') # pretrained model to be further fine-tuned
