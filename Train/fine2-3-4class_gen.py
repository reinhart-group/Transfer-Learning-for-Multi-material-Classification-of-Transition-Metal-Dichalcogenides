...
train_val_groups, train_val_X, train_val_Y, test_X, test_Y = stratified_train_test_group_kfold_multilabel(X, Y,label_dict, groups, n_splits=10, test_fold=0)
...
model_path = 'CNNI_AFM_res152_fine2-3-4label-train_val_total'
...
PATH = os.path.join(base_path, 'Models/CNNI_AFM_res152_fine2-3label/Fold2.pth') # pretrained model to be further fine-tuned
